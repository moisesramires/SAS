...
with open('tut6.csv', newline='') as csvfile:
...
for i in cluster_intersection:
	...
	x2_dict[(int(i[0]))].append((float(i[7].replace('"', ''))+float(i[8].replace('"', '')))/7237*1000)
	x3_dict[(int(i[0]))].append(float(i[8].replace('"', ''))/7237*1000)

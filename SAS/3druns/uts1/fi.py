...
samples = []
dataset = []
with open('../../datasets/uts1/UTS1_trnrss_no_unDetected_no_bellow_treshold.csv', newline='') as csvfile:
	spamreader = csv.reader(csvfile, delimiter=';', quotechar='|')
	for row in spamreader:
		samples.append(row) # samples RSSI
		

with open('../../datasets/uts1/UTS1_trncrd_no_unDetected_no_bellow_treshold.csv', newline='') as csvfile:
	spamreader = csv.reader(csvfile, delimiter=';', quotechar='|')
	for row in spamreader:
...
samples2 = []
dataset2 = []
with open('../../datasets/uts1/UTS1_tstrss_no_unDetected_no_bellow_treshold.csv', newline='') as csvfile:
	spamreader = csv.reader(csvfile, delimiter=';', quotechar='|')
	for row in spamreader:
		samples2.append(row) # samples RSSI
		

with open('../../datasets/uts1/UTS1_tstcrd_no_unDetected_no_bellow_treshold.csv', newline='') as csvfile:
	spamreader = csv.reader(csvfile, delimiter=';', quotechar='|')
	for row in spamreader:
...
writer = csv.writer(open('test_ust1.csv', 'a', newline=''), delimiter = ";")
...
for N in range(1,12):
	for P in range(0,N):
		...
		timeSAS = 0
		time1 = time.time()
		clusters=SAS.cluster_int(N, P, samples, -97, "Cluster" )
		...
		for i in samples2:
			...
			samples_in_cluster=SAS.cluster_identification(i,clusters, N,-97)

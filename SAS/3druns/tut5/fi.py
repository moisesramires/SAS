...
writer = csv.writer(open('tut5_test.csv', 'a', newline=''), delimiter = ";")
...
for N in range(15,20):
	for P in range(0,N):
		...
		timeSAS = 0
		time1 = time.time()
		clusters=SAS.cluster_int(N, P, samples, -94, "Cluster" )
		...
		for i in samples2:
			...
			samples_in_cluster=SAS.cluster_identification(i,clusters, N,-94)
